...
export function PanelFooter({ market }: { market: OfferMarketContext }) {
  return <footer id="footer" className="bg-[#17120f] px-4 py-10 text-center text-sm text-[#a39486] sm:px-6"><div className="mx-auto max-w-4xl"><strong className="font-display text-3xl text-[#f5ece2]">E-com.casa</strong><p className="mt-2 text-xs">A sua casa, à sua maneira.</p><address className="mt-4 not-italic leading-6"><span className="block">{COMPANY.legalName} · N.º de registo {COMPANY.companyNumber}</span><span className="block">{COMPANY.registeredOffice.line1}, {COMPANY.registeredOffice.line2} · {COMPANY.registeredOffice.city} {COMPANY.registeredOffice.postcode} · {COMPANY.registeredOffice.country}</span><span className="block"><a href="mailto:suporte@nuraltainteriores.online" className="hover:text-[#f5ece2]">suporte@nuraltainteriores.online</a> · <a href="tel:+351913482761" className="hover:text-[#f5ece2]">+351 913 482 761</a></span></address><nav aria-label="Informação legal" className="mt-6 flex flex-wrap justify-center gap-x-5 gap-y-3 text-xs"><Link href="/offers/painel-ripado/informacao/envios">Envios</Link><Link href="/offers/painel-ripado/informacao/privacidade">Privacidade</Link><Link href="/offers/painel-ripado/informacao/trocas-e-devolucoes">Trocas e devoluções</Link><Link href="/offers/painel-ripado/informacao/termos-e-condicoes">Termos e condições</Link><Link href="/offers/painel-ripado/informacao/contacto">Contacto</Link><a href={COMPANY.ptComplaintsBook} target="_blank" rel="noreferrer">Livro de Reclamações</a><Link href="/offers/painel-ripado/informacao/dados-da-empresa">Dados da empresa</Link></nav><div className="mx-auto mt-7 w-fit border-t border-white/10 pt-6 text-left"><PaymentBrandStrip country={market.countryCode} currency={market.currency} variant="footer" caption="Meios de pagamento disponíveis" /></div><p className="mt-7 border-t border-white/10 pt-6 text-xs leading-5">E-com.casa é uma marca comercial operada por {COMPANY.legalName}, registada em Inglaterra e País de Gales.<br />© 2026 E-com.casa. Todos os direitos reservados.</p></div></footer>;
}

  ...
  return (
    <div className="mx-auto flex min-h-[55vh] max-w-lg flex-col items-center justify-center px-5 py-16 text-center">
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3">
        ...
        <Link href="/offers/painel-ripado?carrinho=aberto" className="inline-flex h-11 items-center rounded-md border border-[#201a17] px-5 text-[13px] font-semibold text-[#201a17]">
          Voltar ao carrinho
        </Link>
      </div>
    </div>
